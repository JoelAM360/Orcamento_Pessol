      ...
      <input type="checkbox" id="check" style='display:none'>
       ...
       <div class="row" style="height:100%;">
        ...
        <!--Sidebar-->
          ...
          <!--Conteudo-->
          <div class="container col-sm-8 col-md-8 mt-2 mt-md-3 mr-sm-5" id='container'>
                <div class="clearfix p-1 p-md-2" style=" border-bottom: 1px solid #c2c1c1c7;">
                   <span > <strong><?= $_SESSION['nome'] ?></strong> > <a href="home.php">Home</a></span>
              ...
              <div class="card mt-3 mt-md-5" style="box-shadow: 5px 5px 5px 5px rgb(16 42 67 / 30%);">
                    ...
                    <!--Card Body-->
                    <div class="card-body" style="height:52vh; overflow:hidden;overflow-x: auto;">
                       <!-- Form-->
                            ...
                            <?php if (isset($_GET['filtrado'])) {?>
                              <?php foreach ($_SESSION['filtrar'] as $value) {?>
                                <tr>
                                  ...
                                  <td>
                                    <a href="" class='btn text-success' data-toggle="modal" data-target="#id_despesa_<?= $value->id_despesa ?>">Done</a>
                                    <!-- Modal -->
                                  ...
                                  <td>
                                    ...
                                    <div class="modal fade" id="id_despesa_<?= $value->id_despesa ?>" tabindex="-1" aria-labelledby="label_<?= $value->id_despesa ?>" aria-hidden="true">
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="label_<?= $value->id_despesa ?>">Modal title</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true">&times;</span>
                                            </button>
                                          </div>
